...
import negocio.estacionamiento.FactoriaSA;
import negocio.estacionamiento.SAPlaza;
import negocio.estacionamiento.TransferPlaza;
import presentacion.estacionamiento.CUs.GUIListaPlazas;
import presentacion.estacionamiento.CUs.GUIConfirmarSalida;
import presentacion.estacionamiento.CUs.GUICrearPlaza;
import presentacion.estacionamiento.CUs.GUIEliminarPlaza;
import presentacion.estacionamiento.CUs.GUIIngresoSalida;
import presentacion.estacionamiento.CUs.GUIInputMatriculaPlaza;
import presentacion.estacionamiento.CUs.GUIMenuCUs;
import presentacion.estacionamiento.CUs.GUIModificarPlaza;
import presentacion.estacionamiento.CUs.GUIOpcionesMantenimientoImp;
        ...
        try {
            switch (evento) {
                ...
                case Eventos.INICIAR_SALIDA:
                    ...
                    if (p.getEstado() != EstadoPlaza.OCUPADA) {
