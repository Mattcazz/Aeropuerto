...
public class GUIEliminarPanelImp extends GUIEliminarPanel {
	...
	String descFunc = "Se eliminará el panel";
		...
		funcButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (filaSeleccionada != -1) {
					Controlador.getInstancia().accion(Eventos.ELIMINAR_PANEL, (int) modelo.getValueAt(filaSeleccionada, 0));
					filaSeleccionada = -1;
				}
				else {
					Controlador.getInstancia().accion(Eventos.SIN_DATOS, GUIEliminarPanel.getInstancia());
				}
